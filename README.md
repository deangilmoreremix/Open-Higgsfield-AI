...
|-----|-------------|------|
| **VFX Studio** | 80+ professional visual effects, camera moves, and video processing | 8083 |
| **Sendspark Workflow** | Video workflow automation with MuAPI integration | 8084 |

Both standalone apps are served through the main Vite dev server via proxy and appear in the sidebar navigation.
...
# Standalone applications (run on separate ports, proxied through Vite)
apps/
├── vfx-studio/          # Visual effects studio (80+ effects, 50+ camera moves)
│   ├── src/
...
│   ├── index.html
│   ├── package.json
│   └── vite.config.js   # Port 8083
├── sendspark-workflow/  # Workflow automation platform
│   ├── src/
│   │   ├── App.jsx      # Workflow manager with MuAPI integration
│   │   ├── main.jsx     # Entry point
│   │   └── styles.css   # App-specific styles
│   ├── index.html
│   ├── package.json
│   └── vite.config.js   # Port 8084
├── director/            # Video agent framework (Vue)
│   └── frontend/
├── vimax/               # Agentic video generation (React/CRA)
│   └── frontend/
└── remix-go/            # Advanced video editor (React/Vite)

# Supabase edge functions
supabase/
├── functions/
│   ├── muapi-proxy/     # MuAPI proxy with rate limiting
│   ├── director-agent/  # Director AI agent
...
├── .env                 # Environment variables (MuAPI key, Supabase)
