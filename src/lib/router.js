...
const ROUTE_MAP = {
  ...
  'AI Video Outreach': 'ai-video-outreach',
  'AI Headshot Generator': 'ai-headshot-generator',
  'AI Influencer Generator': 'ai-influencer-generator',
  'AI Shorts Generator': 'ai-shorts-generator',
  'Free Social Scheduler': 'free-social-scheduler',
  'Open AI UGC': 'open-ai-ugc',
  'Open Pomelli': 'open-pomelli',
...
const pageLoaders = {
  ...
  'ai-video-outreach': () => import('../components/StandaloneAppPage.js').then(m => m.StandaloneAppPage('ai-video-outreach')),
  'ai-headshot-generator': () => import('../components/StandaloneAppPage.js').then(m => m.StandaloneAppPage('ai-headshot-generator')),
  'ai-influencer-generator': () => import('../components/StandaloneAppPage.js').then(m => m.StandaloneAppPage('ai-influencer-generator')),
  'ai-shorts-generator': () => import('../components/StandaloneAppPage.js').then(m => m.StandaloneAppPage('ai-shorts-generator')),
  'free-social-scheduler': () => import('../components/StandaloneAppPage.js').then(m => m.StandaloneAppPage('free-social-scheduler')),
  'open-ai-ugc': () => import('../components/StandaloneAppPage.js').then(m => m.StandaloneAppPage('open-ai-ugc')),
  'open-pomelli': () => import('../components/StandaloneAppPage.js').then(m => m.StandaloneAppPage('open-pomelli')),
