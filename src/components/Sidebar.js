...
{ id: 'remix-go', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="M10 9l5 3-5 3V9z"/><circle cx="16" cy="14" r="2"/></svg>', label: 'Remix Go', tooltip: 'Remix Go — Quickly remix and iterate on existing projects and templates' },
    { id: 'videco-ai-platform', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="1" y="5" width="15" height="14" rx="2"/><polygon points="23 7 16 12 23 17"/></svg>', label: 'Videco', tooltip: 'Videco AI Platform — Professional AI video generation suite' },
    { id: 'free-social-scheduler', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M8 22h8"/><path d="M5 12c-1.1 0-2-.9-2-2V5c0-1.1.9-2 2-2h14c1.1 0 2 .9 2 2v5c0 1.1-.9 2-2 2H5z"/><path d="M2 18h20"/><path d="M2 14h20"/></svg>', label: 'Scheduler', tooltip: 'Free AI Social Media Scheduler — Schedule and auto-post to social platforms' },
    { id: 'ai-influencer-generator', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/><path d="M12 11v2"/><path d="M8 14c1 1 4 1 8 0"/></svg>', label: 'Influencer', tooltip: 'AI Influencer Generator — Create AI influencers with avatars and lip-sync videos' },
    { id: 'ai-shorts-generator', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 19V5M5 12l7-7 7 7"/></svg>', label: 'Shorts', tooltip: 'AI YouTube Shorts Generator — Turn long videos into viral vertical shorts' },
    { id: 'open-ai-ugc', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="10" y1="18" x2="14" y2="18"/><line x1="10" y1="14" x2="14" y2="14"/><line x1="10" y1="10" x2="14" y2="10"/></svg>', label: 'UGC', tooltip: 'Open AI UGC — User-generated content creation platform' },
  ];
