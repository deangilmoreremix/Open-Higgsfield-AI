export function Sidebar(navigate) {
  ...
  const navItems = [
    ...
    { id: 'agents-app', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="6" width="18" height="12" rx="2"/><circle cx="8" cy="10" r="2"/><circle cx="16" cy="10" r="2"/><path d="M8 14h8"/></svg>', label: 'Agents', tooltip: 'Agents App — Create and manage AI agents with specialized capabilities' },
    ...
    { id: 'ai-video-outreach', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 4L2 12l7 3 3 7 10-18z"/><path d="M22 4L9 15"/><circle cx="18" cy="6" r="2"/></svg>', label: 'Outreach', tooltip: 'AI Video Outreach — Create personalized video campaigns at scale' },
    { id: 'ai-headshot-generator', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="4"/><circle cx="12" cy="10" r="4"/><path d="M8 21v-2a4 4 0 0 1 8 0v2"/></svg>', label: 'Headshot', tooltip: 'AI Headshot Generator — Professional headshots with AI enhancement' },
    ...
    { id: 'ai-shorts-generator', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="M10 8l5 4-5 4V8z"/><path d="M15 8l-5 4"/></svg>', label: 'Shorts', tooltip: 'AI Shorts Generator — Create short-form video content for social media' },
    { id: 'free-social-scheduler', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>', label: 'Scheduler', tooltip: 'Free Social Scheduler — Schedule and manage social media posts' },
    { id: 'open-ai-ugc', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>', label: 'UGC', tooltip: 'Open AI UGC — Generate user-generated content with AI' },
    { id: 'open-pomelli', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8"/><path d="M12 17v4"/><path d="M7 8h10"/><path d="M7 12h6"/></svg>', label: 'Pomelli', tooltip: 'Open Pomelli — AI marketing studio for brand DNA and campaigns' },
    ...
    { id: 'open-lip-sync', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 3c-2 0-4 1.5-4 4v5c0 2.5 2 4 4 4s4-1.5 4-4V7c0-2.5-2-4-4-4z"/><path d="M8 14v2"/><path d="M12 14v2"/><path d="M16 14v2"/></svg>', label: 'LipSync', tooltip: 'Lip Sync Studio — Animate faces to sync with audio using AI' },
    { id: 'open-ai-clipping', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="6" cy="6" r="3"/><path d="M6 9v12"/><path d="M6 9l6 3 6-3"/><rect x="15" y="3" width="6" height="6" rx="1"/></svg>', label: 'Clip', tooltip: 'AI Clipping — Auto-detect and extract highlights from long videos' },
    { id: 'open-vibe-motion', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 12c0-3 2.5-6 6-6s6 3 6 6-2.5 6-6 6"/><path d="M2 12c0 3 2.5 6 6 6s6-3 6-6"/><path d="M14 6c2 0 4 2 4 4s-2 4-4 4"/></svg>', label: 'Vibe', tooltip: 'Vibe Motion — Add fluid motion effects and animations to media' },
    { id: 'open-cinema', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="2" width="20" height="20" rx="2.18"/><line x1="7" y1="2" x2="7" y2="22"/><line x1="17" y1="2" x2="17" y2="22"/><line x1="2" y1="12" x2="22" y2="12"/></svg>', label: 'Cinema', tooltip: 'Cinema Studio — Cinematic camera controls and film-style effects' },
    { id: 'open-marketing', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 5h18v14H3z"/><path d="M7 9h10"/><path d="M7 13h6"/><circle cx="19" cy="9" r="3"/></svg>', label: 'Market', tooltip: 'Marketing Studio — Create ad campaigns and promotional content with AI' },
    { id: 'open-workflows', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="5" r="3"/><circle cx="5" cy="19" r="3"/><circle cx="19" cy="19" r="3"/><line x1="12" y1="8" x2="5" y2="16"/><line x1="12" y1="8" x2="19" y2="16"/></svg>', label: 'Workflow', tooltip: 'Workflows Studio — Build multi-step AI automation pipelines' },
    { id: 'open-agents', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="6" width="18" height="12" rx="2"/><circle cx="8" cy="10" r="2"/><circle cx="16" cy="10" r="2"/><path d="M8 14h8"/></svg>', label: 'Agents', tooltip: 'Agents Studio — Create and manage AI agents for creative tasks' },
    { id: 'open-design-agent', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8"/><path d="M12 17v4"/><circle cx="12" cy="10" r="3"/></svg>', label: 'Design', tooltip: 'Design Agent — AI design assistant for layouts, graphics, and creative projects' },
];
