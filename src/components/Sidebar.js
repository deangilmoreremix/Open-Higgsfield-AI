export function Sidebar(navigate) {
  ...
  const navItems = [
    ...
    { id: 'open-generative-ai', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2L15.09 8.26L22 9.27L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2z"/></svg>', label: 'Gen AI', tooltip: 'Open Generative AI — All 11 studios: Image, Video, Audio, Lip Sync, Clipping, Vibe Motion, Cinema, Marketing, Workflows, Agents, Design' },
    { id: 'agents-app', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2a4 4 0 0 1 4 4 4 4 0 0 1-4 4 4 4 0 0 1-4-4 4 4 0 0 1 4-4zm7 10a4 4 0 0 1-4 4v.5a8 8 0 0 1-8 0V16a4 4 0 0 1 4-4h8z"/></svg>', label: 'Agents', tooltip: 'Agents App — Create and manage AI agents with specialized capabilities' },
    { id: 'assistant-app', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>', label: 'Assistant', tooltip: 'Assistant App — AI-powered assistant for creative workflows and support' },
    { id: 'ai-video-outreach', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 4L2 12l7 3 3 7 10-18z"/><path d="M22 4L9 15"/></svg>', label: 'Outreach', tooltip: 'AI Video Outreach — Create personalized video campaigns at scale' },
];
