export function Sidebar(navigate) {
  ...
  const navItems = [
    ...
    { id: 'videco', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M15 3h1a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h2"/><path d="M12 13l4 4M8 13l4 4M12 7V3"/><path d="M8 7V3"/><path d="M16 7V3"/></svg>', label: 'Videco', tooltip: 'Videco AI Platform — Personalized video generation for cold outreach and sales' },
