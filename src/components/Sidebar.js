export function Sidebar(navigate) {
  ...
  const navItems = [
    ...
    { id: 'vfx-studio', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 2L3 6v12l6-4"/><path d="M15 2l6 4v12l-6-4"/><path d="M3 10l6 4 6-4"/><circle cx="9" cy="16" r="2"/><circle cx="15" cy="16" r="2"/></svg>', label: 'VFX Studio' },
    { id: 'sendspark-workflow', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M2 12l10 5 10-5"/><circle cx="12" cy="7" r="3"/><circle cx="12" cy="12" r="3"/><circle cx="12" cy="17" r="3"/></svg>', label: 'Sendspark Workflow' },
  ];
