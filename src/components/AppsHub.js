...
const AI_APPS = [
  ...
  { id: 'vfx-studio', name: 'VFX Studio', description: '80+ professional visual effects and camera moves', icon: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M9 2L3 6v12l6-4"/><path d="M15 2l6 4v12l-6-4"/><path d="M3 10l6 4 6-4"/></svg>', badge: '80+ VFX', color: 'bg-orange-500/10 text-orange-400 border-orange-500/20' },
  { id: 'sendspark-workflow', name: 'Sendspark Workflow', description: 'Automate video creation, personalization & distribution with MuAPI', icon: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M2 12l10 5 10-5"/><circle cx="12" cy="7" r="3"/><circle cx="12" cy="12" r="3"/><circle cx="12" cy="17" r="3"/></svg>', badge: 'Automation', color: 'bg-green-500/10 text-green-400 border-green-500/20' },
];
