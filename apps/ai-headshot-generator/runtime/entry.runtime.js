import { HeadshotRuntimeAdapter } from './adapter.js';

export function mountNative(container, options = {}) {
  const adapter = new HeadshotRuntimeAdapter(options);
  ...
  appUI.innerHTML = `
    <div class="p-4 border-b border-white/10">
      ...
      <p class="text-sm text-secondary">Professional headshots for LinkedIn, team portraits, and personal branding</p>
    </div>
    <div id="runtime-status" class="p-4">
      <p class="text-xs text-secondary">Upload a photo to get started</p>
    </div>
  `;
